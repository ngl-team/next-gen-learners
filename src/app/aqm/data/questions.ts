...
export const questions: Question[] = [
  // ============ TECHNIQUE MATCHING ============
  {
    ...
    options: ['Clustering', 'Association Rules', 'Classification', 'Regression'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Clustering', 'Classification', 'Association Rules', 'Regression'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Regression', 'Association Rules', 'Classification', 'Clustering'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Regression', 'Clustering', 'Association Rules', 'Classification'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Association Rules', 'Classification', 'Clustering', 'Regression'],
    correctIndex: 3,
  ...
  // ============ R BASICS ============
  {
    ...
    options: ['df$Price == 100', 'View(df)', 'mean(df$price)', 'prices = c(100, 200, 300)'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Logical', 'Integer', 'Character', 'Factor'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['df[1:5 -2, ]', 'df[-2, ]', 'df[-2]', 'df[ ,-2]'],
    correctIndex: 1,
  ...
  },
  {
    ...
    table: {
      headers: ['Final_Grade', 'Class', 'Hours_Studied'],
      rows: [
        ['89', '1', '2'],
        ['92', '3', '3'],
        ['81', '4', '7'],
  ...
  },
  {
    ...
    options: ['summary()', 'View()', 'str()', 'All responses listed here'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Scatterplot', 'Stacked bar', 'Histogram', 'Line chart'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Line chart', 'Histogram', 'Stacked bar chart', 'Scatterplot'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: [
      ...
      'Bachelors graduates earn $12,000 per year',
      'On average, Bachelors earn $12,000 more than Masters',
      '12,000 is the increase in salary from a base of zero education',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      'Urban houses cost less than suburban houses',
      'Being in an urban neighborhood decreases home value by $1,500',
      ...
      'Urban neighborhoods reduce price by 1.5%',
    ],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['25,000', '20,000', '33,300', '36,667'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Wind', 'Temp', 'Weekend', 'Precipitation'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Weekend', 'Wind', 'Precipitation', 'You can use all of them'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Because data mining focuses on improving predictive accuracy over time',
      'Because it always leads to deployment in production systems',
    ],
    correctIndex: 1,
