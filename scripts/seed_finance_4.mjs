...
// Backfill Ryan's Anthropic Claude — same amount as Brayan, will adjust later.
const entries = [
  { date: '2026-04-01', desc: 'Anthropic Claude (Ryan)', person: 'Ryan' },
  { date: '2026-05-01', desc: 'Anthropic Claude (Ryan)', person: 'Ryan' },
];
